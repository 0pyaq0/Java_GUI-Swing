...
public class rentalPanel extends Frame implements ActionListener, ItemListener, Runnable{
	...
	public void init() {
		ImagePanel rentalPanel = new ImagePanel(new ImageIcon("C:\\Users\\82108\\OneDrive\\바탕 화면\\Java_Umbrella\\Umbrella\\img\\rentalsrc.png").getImage());
		...
		btn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if((JButton)obj == btn) {
					...
					String ex_Num = in_num.getText();
					String ex_phone = in_phone.getText();
					
					try {
						if(umbrella_cnt != 0 && ex_Num.length()==4) {
							insertDAO.create(dto); // dto를 DAO에 넘김
							umbrella_cnt--;
							JOptionPane.showMessageDialog(null, "우산 대여 완료\n\n대여일 : " + format_today + "\n반납일 : " + format_end, "대여 완료", JOptionPane.INFORMATION_MESSAGE);
							setVisible(false);
							new homePanel("홈");
						} 
						else{
		...
		btn.setIcon(new ImageIcon("C:\\Users\\82108\\OneDrive\\바탕 화면\\Java_Umbrella\\Umbrella\\img\\go_rentalbtn.png"));
